...
int shell_env(char **args, char __attribute__((__unused__)) **frnt);
int shell_setenv(char **args, char __attribute__((__unused__)) **frnt);
int shell_unsetenv(char **args, char __attribute__((__unused__)) **frnt);
int shell_cd(char **args, char __attribute__((__unused__)) **frnt);
int shell_alias(char **args, char __attribute__((__unused__)) **frnt);
